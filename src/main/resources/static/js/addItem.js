/**
 *  商品追加画面におけるJavaScriptの動作をまとめたファイル
 */
$(function(){
    ...
    $('#button-add').on('click', function() {  	
      ...
      if ('' == categoryName) {
    	  $('#addItemForm [name=bigCategoryId]').val(null); 
    	  $('#addItemForm [name=middleCategoryId]').val(null); 
    	  $('#addItemForm [name=smallCategoryId]').val(null); 
      }
      $('#addItemForm [name=categoryName]').val(createCategoryName());
      $('#addItemForm').submit();
    });
